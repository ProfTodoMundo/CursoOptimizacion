...
\subsection{Metodolog\'ia del curso}
...
La calificaci\'on final del curso se obtiene de la suma de los siguientes porcentajes: \textit{Calificaci\'on Final} $=$ \textit{Portafolio} (30\%) $+$ \textit{Biograf\'ias} ($10\%$) $ +$ \textit{Evaluaciones} ($60\%$).


\subsection{Cient\'ificos prominentes}
